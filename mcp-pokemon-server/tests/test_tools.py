...
from src.models.pokemon_models import Pokemon, PokemonType, PokemonStat, PokemonAbility, PokemonSprites
...
async def test_search_pokemon():
    ...
    with patch('src.tools.pokemon_tools.get_pokemon_client') as mock_client:
        mock_api_client = AsyncMock()
        mock_api_client.search_pokemon.return_value = type('SearchResult', (), search_result)
        mock_client.return_value = mock_api_client
