...
class BattlePromptManager:
    ...
    async def create_battle_strategy_prompt(
        ...
        try:
            ...
            prompt_text = self._generate_battle_strategy_prompt_text(
                user_team_data, opponent_team_data, battle_format, strategy_focus, context
            )
            
            description = f"Battle strategy prompt - {strategy_focus} {battle_format} format"
            if opponent_team:
    ...
    async def create_team_preview_prompt(
        ...
        try:
            ...
            context = self._build_team_preview_context(team_data, analysis_depth, focus_areas)
    ...
    def _build_battle_strategy_context(
        ...
        return {
            ...
            "format_guidance": format_specific_guidance.get(battle_format, format_specific_guidance["singles"]),
            "strategy_approach": strategy_approaches.get(strategy_focus, strategy_approaches["balanced"]),
...
"""
    ...
    def _build_matchup_analysis_context(
        ...
        return {
            "system_message": system_message,
            "scenario_context": scenario_contexts.get(scenario, scenario_contexts["1v1"]),
            "environment_effects": environment_effects.get(environment, environment_effects["neutral"]),
...
"""
    ...
    def _build_team_preview_context(
        ...
        return {
            "system_message": system_message,
            "depth_description": depth_descriptions.get(analysis_depth, depth_descriptions["standard"]),
